...
var ERC20 = /** @class */ (function (_super) {
    ...
    ERC20.prototype.withdrawExit_ = function (burnTransactionHash, isFast, option) {
        ...
        return this.exitUtil.buildPayloadForExit(burnTransactionHash, 0, eventSignature, isFast).then(function (payload) {
...
var ERC721 = /** @class */ (function (_super) {
    ...
    ERC721.prototype.withdrawExit = function (burnTransactionHash, option) {
        var _this = this;
        this.checkForRoot("withdrawExit");
        return this.exitUtil.buildPayloadForExit(burnTransactionHash, 0, _enums__WEBPACK_IMPORTED_MODULE_2__["Log_Event_Signature"].Erc721Transfer, false).then(function (payload) {
            return _this.rootChainManager.exit(payload, option);
        });
    };
    ERC721.prototype.withdrawExitOnIndex = function (burnTransactionHash, index, option) {
        var _this = this;
        this.checkForRoot("withdrawExit");
        return this.exitUtil.buildPayloadForExit(burnTransactionHash, index, _enums__WEBPACK_IMPORTED_MODULE_2__["Log_Event_Signature"].Erc721Transfer, false).then(function (payload) {
            return _this.rootChainManager.exit(payload, option);
        });
    };
    ...
    ERC721.prototype.withdrawExitFaster = function (burnTransactionHash, option) {
        var _this = this;
        this.checkForRoot("withdrawExitFaster");
        return this.exitUtil.buildPayloadForExit(burnTransactionHash, 0, _enums__WEBPACK_IMPORTED_MODULE_2__["Log_Event_Signature"].Erc721Transfer, true).then(function (payload) {
            return _this.rootChainManager.exit(payload, option);
        });
    };
...
var ExitUtil = /** @class */ (function () {
    ...
    ExitUtil.prototype.buildPayloadForExit = function (burnTxHash, index, logEventSig, isFast) {
        var _this = this;
...
var POSToken = /** @class */ (function (_super) {
    ...
    POSToken.prototype.withdrawExitPOS = function (burnTxHash, eventSignature, isFast, option) {
        var _this = this;
        return this.exitUtil.buildPayloadForExit(burnTxHash, 0, eventSignature, isFast).then(function (payload) {
            return _this.rootChainManager.exit(payload, option);
        });
    };
    return POSToken;
